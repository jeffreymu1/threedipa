"""Simple render test for shutter glasses using PsychoPy, Stimulus2D, and ShutterRenderer3D."""
...
from threedipa.renderer.renderers import ShutterRenderer3D
